...
<div align="center">
	...
	<form id="reauestApprovalDetail" action="${pageContext.request.contextPath}/approval/reauestApprovalDetail.do" method="GET">
...
function detail(j,ck) {
	$('<input></input>').attr('type','hidden').attr('value',j).attr('name','apprKey').appendTo('#reauestApprovalDetail');
	$('<input></input>').attr('type','hidden').attr('value',ck).attr('name','ckKey').appendTo('#reauestApprovalDetail');
	console.log(ck);
	$('#reauestApprovalDetail').submit();	
}
