	...
	<div class="container">
		<div class="card">
			...
			<div class="container-inner card-body">
				<form action="${pageContext.request.contextPath}/om/omAttachedList"
					method="GET">
					...
					<ul class="nav nav-tabs" id="addl-btns" role="tablist">
						...
						<li class="nav-item"><a class="nav-link" id="deptOM-tab"
							href="${pageContext.request.contextPath}/om/omTeamList.do"
							role="tab" aria-controls="deptOM" aria-selected="false">내 부서
								메일</a></li>
						<li class="nav-item"><a class="nav-link active"
							id="attachedOM-tab"
							href="${pageContext.request.contextPath}/om/omAttachedList.do"
							role="tab" aria-controls="attachedOM" aria-selected="true">첨부
								메일</a></li>
					</ul>
					<!-- 여기까지 네비게이션 헤더 -->
