	...
	<div class="container">
		<div class="card">
			<h4 id="m-title" class="card-header">
				<strong>내 부서 메일</strong>
			</h4>
			<div class="container-inner card-body">
				<form action="${pageContext.request.contextPath}/om/omTeamList"
					method="GET">
					...
					<ul class="nav nav-tabs" id="addl-btns" role="tablist">
						<li class="nav-item"><a class="nav-link" id="allOM-tab"
							...
							aria-controls="allOM" aria-selected="false">전체</a></li>
						<li class="nav-item"><a class="nav-link active"
							id="deptOM-tab"
							href="${pageContext.request.contextPath}/om/omTeamList.do"
							role="tab" aria-controls="deptOM" aria-selected="true">내 부서
								메일</a></li>
						<li class="nav-item"><a class="nav-link" id="attachedOM-tab"
							href="${pageContext.request.contextPath}/om/omAttachedList.do"
							role="tab" aria-controls="attachedOM" aria-selected="false">첨부
								메일</a></li>
					</ul>
					<!-- 여기까지 네비게이션 헤더 -->
