...
<div id="wrapper">
	...
	<ul
		...
		<li class="nav-item"><a class="nav-link"
			href="${pageContext.request.contextPath}/board/boardMaList.do"> <i
				class="fas fa-fw fa-exclamation"></i> <span>공지사항</span></a></li>
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			data-toggle="collapse" data-target="#approval" aria-expanded="false"
			aria-controls="collapsePages"> <i class="fas fa-fw fa-file"></i>
				<span>전자결재</span>
		</a>
			<div id="approval" class="collapse" aria-labelledby="headingPages"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item"
						href="${pageContext.request.contextPath}/approval/false">미결재문서</a>
		...
		<!-- 일정 관리 -->
		<li class="nav-item"><a class="nav-link"
			href="${pageContext.request.contextPath}/calendar/calendar.do"> <i
				class="fas fa-fw fa-calendar-alt"></i> <span>일정관리</span></a></li>

		<!-- 근태 관리 -->
		<li class="nav-item"><a class="nav-link"
			href="${pageContext.request.contextPath}/attend/attend.do"> <i
				class="fas fa-fw fa-building"></i> <span>근태관리</span></a></li>

		<!-- 게시판 -->
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			data-toggle="collapse" data-target="#board" aria-expanded="false"
			...
			<div id="board" class="collapse" aria-labelledby="headingPages"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					<a class="collapse-item"
						href="${pageContext.request.contextPath}/board/boardList.do">전사
						게시판</a> <a class="collapse-item"
						href="${pageContext.request.contextPath}/board/boardTeamList.do">부서
						게시판</a>
				</div>
			</div></li>
		...
		<!-- 조직도 -->
		<li class="nav-item"><a class="nav-link"
			href="${pageContext.request.contextPath}/member/organization.do">
				<i class="fas fa-fw fa-sitemap"></i> <span>조직도</span>
		</a></li>

		<li class="nav-item"><a class="nav-link"
			href="${pageContext.request.contextPath}/room"> <i
				class="fas fa-fw fa-comments"></i> <span>채팅방</span></a></li>
		...
		<c:if test="${ loginMember.isManager eq 1 }">
			...
			<div class="sidebar-heading text-white">
				<i class="fas fa-fw fa-cog"></i> 관리자
			</div>

			<!-- 사원 관리 -->
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#manager" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-fw fa-user"></i> <span>사원
						관리</span>
			</a>
				<div id="manager" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<!-- <h6 class="collapse-header">사원 관리</h6> -->
						<a class="collapse-item"
							href="${pageContext.request.contextPath}/manager/insertMember.do">사원
							등록</a> <a class="collapse-item"
			...
			<!-- 부서 관리 -->
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#dept" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-fw fa-users"></i>
					<span>부서 관리</span>
			</a>
				<div id="dept" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<!-- <h6 class="collapse-header">부서 관리</h6> -->
						<a class="collapse-item"
							href="${pageContext.request.contextPath}/manager/insertDept.do">부서
							생성</a> <a class="collapse-item"
			...
			<!-- 직급 관리 -->
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#position" aria-expanded="true"
				aria-controls="collapseTwo"> <i class="fas fa-fw fa-user-tie"></i>
					<span>직급 관리</span>
			</a>
				<div id="position" class="collapse" aria-labelledby="headingTwo"
					data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<!-- <h6 class="collapse-header">직급 관리</h6> -->
						<a class="collapse-item"
							href="${pageContext.request.contextPath}/manager/insertRank.do">직급
							생성</a> <a class="collapse-item"
							href="${pageContext.request.contextPath}/manager/manageRank.do">직급
							정보</a>
					</div>
				</div></li>
			...
			<!-- 전자결재 관리 -->
			<li class="nav-item"><a class="nav-link collapsed" href="#"
				data-toggle="collapse" data-target="#approval-manage"
				aria-expanded="true" aria-controls="collapseTwo"> <i
					class="fas fa-fw fa-file"></i> <span>전자결재 관리</span>
			</a>
				<div id="approval-manage" class="collapse"
					aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<!-- <h6 class="collapse-header">전자결재 관리</h6> -->
						<a class="collapse-item"
							href="${pageContext.request.contextPath}/manager/insertApprovalDoc.do">전자결재
							양식 생성</a> <a class="collapse-item"
							href="${pageContext.request.contextPath}/manager/manageApprovalDoc.do">전자결재
							양식 조회</a>
					</div>
				</div></li>
                  ...
                  <div>
                    ...
                    Spending Alert: We've noticed unusually high spending for your account.
							...
							<a class="dropdown-item text-center small text-gray-500"
								href="${pageContext.request.contextPath}/notice/noticeList.do">모든
								알림 확인하기</a>
						</div></li>
                	 ...
                	 ">
						...
						<div
							...
							<a class="dropdown-item"
								...
								href="${pageContext.request.contextPath}/member/updatePassword.do">
